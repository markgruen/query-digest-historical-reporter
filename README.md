...
# License
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/markgruen/query-digest-historical-reporter/edit/master/LICENSE) file for details
